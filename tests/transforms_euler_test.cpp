...
TEST(TestTransForm, Euler2Mat)
{
    ...
    Matrix3d matrix = TransFormsd::EulerAngle2Mat(rot);
    Vector3d rotr = TransFormsd::Mat2EulerAngle(matrix);
    ...
    /* base@llaser1  */
    Matrix4d base2llaser1 = TransFormsd::ComposeEuler(0.043, -0.163, 0.0571, 76, 14, -72.511); // xyz yam pitch roll
